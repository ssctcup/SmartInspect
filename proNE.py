...
def runproNE(graph_dir,dimension,step,mu,theta):
	t_0 = time.time()
	model = ProNE(graph_dir+'edgeset.txt', graph_dir+'feature_matrix.txt', graph_dir+'embeddings_matrix.txt', dimension)
	t_1 = time.time()
	...
	t_3 = time.time()
	print('graph embedding total time:'+ str(t_3-t_0))
	np.savetxt(graph_dir+'embeddings_matrix.txt', embeddings_matrix)
	print('save embedding done')
